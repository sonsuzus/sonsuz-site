...
1. Değişkenler (veriler): NYP ile geliştirilen uygulamalarda ihtiyaç duyulan farklı türden değişkenler [sınıf](https://program.sonsuz.us/search.html?q=s%C4%B1n%C4%B1f) içinde tanımlanır.
...
> NYP ile geliştirilen uygulamalarda program içinde, veriler ile verilere işlem yapacak olan fonksiyonlar (metodlar) sınıf (class) adı verilen yapıların içinde tanımlanır. Sınıf tanımlandıktan sonra bu sınıf türünden bir [değişken](https://program.sonsuz.us/search.html?q=de%C4%9Fi%C5%9Fken) (nesne) oluşturularak, bu nesne yoluyla sınıf içinde yer alan tüm değişken ve fonksiyonlara erişim sağlanır.
{: .prompt-tip }
...
![](/img/cprog/fonkvirtual06.png)
 
![cpp_class-75](/img/cpp_class-75.svg)
