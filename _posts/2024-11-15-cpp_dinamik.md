...
C++'da dinamik bellek işlemleri için [new ve delete](https://program.sonsuz.us/search.html?q=new%20ve%20delete) işlemcileri kullanılır.
...
Bellek tahsis işleminde meydana gelebilecek sorunlar, genellikle [heap bellek](https://program.sonsuz.us/search.html?q=heap%20bellek) alanındaki yetersizlikten ötürü, program tarafından kontrol edilmelidir.
