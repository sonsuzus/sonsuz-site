...
Python bu zahmetli yazım yerine doğrudan negatif [indeks](https://program.sonsuz.us/search.html?q=indeks) kullanmaya izin verir. Negatif indeks kullanmak sondan itibaren saymak anlamına gelir. `L[-i]` ifadesi, sondan `i`‘inci elemanı verir.
