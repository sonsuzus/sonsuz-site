...
Geçici olarak **veri saklamak** için oluşturduğumuz veri yapılarına **değişken** denir. Örneğin bir öğrencinin not ortalamasını hesaplamak istediğimizde hesaplama işlemine gelmeden önce öğrencinin notlarını geçici olarak bir yerde saklamamız gerekir.
