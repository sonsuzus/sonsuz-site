...
redirect_from:
  - /posts/js-switch/
toc: true
image: /img/js-switch-77.png
---

![js-switch-77](/img/js-switch-77.svg)


Javascript uygulamalarında bir duruma bağlı olarak farklı kod bloklarını çalıştırmak istediğimizde [switch](https://program.sonsuz.us/search.html?q=switch) komutunu kullanabiliriniz.
...
**switch**komutuna içeriğini kontrol etmek istediğimiz değişkeni yazıyoruz ve kontrol ettiğimiz değişken içeriğinin alabileceği her farklı değeri [case](https://program.sonsuz.us/search.html?q=case) ile belirtiyoruz.

**[break](https://program.sonsuz.us/search.html?q=break)** komutu ile sonraki durumların kontrolünü geçerek direk switch bloğu dışına çıkabiliyoruz.
