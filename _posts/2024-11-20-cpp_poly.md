...
* Fonksiyonlara çoklu görev tanımlama ([Overloading](https://program.sonsuz.us/search.html?q=overloading)) işlemi
* İşlemcilere çoklu görev tanımlama (Overloading) işlemi
* Sınıf fonksiyonlarını doğrudan yeniden tanımlama (Overriding)
* Sınıf fonksiyonlarını sanal yöntemle ([virtual](https://program.sonsuz.us/search.html?q=virtual)) yeniden tanımlama (Overriding)
...
![cpp_poly-75](/img/cpp_poly-75.svg)
