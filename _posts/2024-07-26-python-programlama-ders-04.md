...
[2. Bölümde](https://program.sonsuz.us/posts/python-programlama-ders-02/#29-girdi) Python tarafından sağlanan ve klavyeden girdi almamızı sağlayan fonksiyonlarını görmüştük: `input()` Şimdi bu fonksiyonu ve kullanımlarını derinlemesine inceleyeceğiz.
