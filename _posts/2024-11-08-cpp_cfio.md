...
redirect_from:
  - /posts/cpp_cfio/
toc: true
image: /img/cpp_cfio-32.png
---


Bu bölümde, C temelli [dosya](https://program.sonsuz.us/search.html?q=dosya) giriş ve çıkış işlemlerini incelemeye çalışacağız. Bu işlemler üzerinde çalışmaya başlamadan önce, [akış](https://program.sonsuz.us/search.html?q=ak%C4%B1%C5%9F) ve dosya kavramlarını ayrı ayrı ele alalım:
...
Akış, [stdio.h](https://program.sonsuz.us/search.html?q=stdio.h) başlık dosyası içinde tanımlı FILE adlı yapı veri türünden bildirimi yapılan bir işaretçi değişkeni ile kullanılan bir dosya veya fiziksel bir cihazdır.
...
![cpp_cfio-32](/img/cpp_cfio-32.svg)
