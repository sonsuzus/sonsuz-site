...
* Küme elemanlarının değerleri değiştirilemez, ancak silinebilir ve yeni [eleman](https://program.sonsuz.us/search.html?q=eleman) eklenebilir.
...
Şimdi, küme elemanlarına sıra ile erişim sağlamak için [döngü](https://program.sonsuz.us/search.html?q=d%C3%B6ng%C3%BC) kullanılmasını bir örnek üzerinde incelemeye çalışalım:
