...
* [Aritmetik işlemciler](https://program.sonsuz.us/search.html?q=aritmetik%20i%C5%9Flemciler): + - \* / % \*\* //
* [Atama işlemcisi](https://program.sonsuz.us/search.html?q=atama%20i%C5%9Flemcisi): =
...
Şimdi, atama işlemcisi ve atama işlemcisinin aritmetik ve [bit işlemcileri](https://program.sonsuz.us/search.html?q=bit%20i%C5%9Flemcileri) ile kullanılmasını bir örnek üzerinde incelemeye çalışalım:
