...
'+' operatörünü kullanarak string birleştirme işlemi bazen zor olabiliyor. Dolayısıyla kullanabileceğimiz **[format](https://program.sonsuz.us/search.html?q=format)()** metodu ile **f-string** isminde iki farklı alternatifimiz mevcut.
...
```py
website = "https://program.sonsuz.us"
