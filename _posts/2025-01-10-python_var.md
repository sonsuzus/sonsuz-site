...
Python'da bir satırda tek bir değişkene ilk değer atanırken, değişkene atanan değerin veri türüne bağlı olarak, değişkenin veri türü otomatik olarak belirlenir. Tek değişken değer [atama](https://program.sonsuz.us/search.html?q=atama) işlemini bir örnek üzerinde incelemeye çalışalım:
