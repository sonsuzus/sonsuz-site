...
Bir sınıf şablonu da fonksiyon şablonu gibi [template](https://program.sonsuz.us/search.html?q=template) ve typename anahtar kelimeleri ile oluşturulur. Sınıf şablonu bildirimi için kullanılan genel yapı aşağıda gösterilmektedir:
...
[Şablon sınıf](https://program.sonsuz.us/search.html?q=%C5%9Fablon%20s%C4%B1n%C4%B1f) bildiriminde sadece tek parametre kullandığımızda, şablon sınıftan her nesne üretilmesinde sadece tek bir veri türü tanımlanır. Sınıf kopyası içinde sadece bu veri türü değişken olarak kullanılabilir.
