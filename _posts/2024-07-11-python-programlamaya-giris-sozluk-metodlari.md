...
Python’daki [veri tiplerini daha önce](https://program.sonsuz.us/posts/python-programlamaya-giris-sayilar-aritmetik-temel-veri-yapilari) kısaca ele almıştık; bir önceki bölümde de [liste tipine ait metodların kullanımını](https://program.sonsuz.us/posts/python-programlamaya-giris-liste-metodlari) örneklerle incelemiştik. Bu yazıda [sözlük](https://program.sonsuz.us/search.html?q=s%C3%B6zl%C3%BCk) tipine ait olan metodları örneklerle açıklıyoruz. Bundan sonraki bölümlerde dize ve küme tiplerine ait metodları inceleyeceğiz.
...
Başında ve sonunda altçizgi olan [metodlar](https://program.sonsuz.us/search.html?q=metodlar) nesne içi kullanım içindir.
