...
`int 43` sayısının [bit gösterimi](https://program.sonsuz.us/search.html?q=bit%20g%C3%B6sterimi):
...
Bir sayı bit gösteriminin üst sınırını aşarsa **[overflow](https://program.sonsuz.us/search.html?q=overflow)** oluşur. Signed gösterimde $2^{n-1}-1$'den sonraki sayı $-2^{n-1}$ olur; unsigned gösterimde $2^n - 1$'den sonraki sayı $0$ olur.
