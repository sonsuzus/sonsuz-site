...
[Robotik](https://program.sonsuz.us/search.html?q=robotik) kodlama robotomuzun istenilen amaca yönelik işlemleri yapma sürecidir diyebiliriz kısaca. Bu aşamada [robot](https://program.sonsuz.us/search.html?q=robot) somut bir nesne olmak zorunda değildir. Bir yazılım ve görsel veya sanal bir yapıda da olabilir. Bu tasarım ve [programlama](https://program.sonsuz.us/search.html?q=programlama) süreci bittiğinde elektronik devreleri olan robotumuza yazılım yüklemesi yapıp onun somut şekilde istenilen biçimde hareket etmesini veya istediğimiz işleri yapmasını sağlayabiliriz.
...
![](https://program.sonsuz.us/img/robotik.jpg)
