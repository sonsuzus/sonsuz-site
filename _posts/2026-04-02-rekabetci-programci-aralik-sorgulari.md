...
Statik bir dizideki toplam sorgularını **[prefix toplam dizisi](https://program.sonsuz.us/search.html?q=prefix%20toplam%20dizisi)** ile kolayca çözebiliriz. Prefix toplam dizisindeki $k$. konum, orijinal dizinin $[0, k]$ aralığının toplamına eşittir; yani `sumq(0, k)` değerini tutar. Bu dizi $O(n)$ zamanda oluşturulabilir.
