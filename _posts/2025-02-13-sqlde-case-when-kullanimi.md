...
Gündelik hayatta elde ettiğimiz sonuçlar veya verdiğimiz kararlar sıklıkla **“[koşullardan](https://program.sonsuz.us/search.html?q=ko%C5%9Fullardan)”** etkilenir. Örnek olarak hava yağmurluysa dışarı çıkarken şemsiyenizi alırsınız veya güneşliyse tişört giyerek dışarı çıkarsınız. Elinizdeki veriyi koşullara göre yeniden düzenleyebilmek ve sorgulayabilmek için SQL’de **[CASE WHEN](https://program.sonsuz.us/search.html?q=case%20when)** ifadesi kullanılır.

## SQL’de CASE WHEN ifadesi ne iş yapar?

Veri tabanı ile konuşurken CASE WHEN ifadesi, birebir çeviri yapacak olursak **“[durum bu olursa](https://program.sonsuz.us/search.html?q=durum%20bu%20olursa), o zaman** **şunu yap”** anlamına gelir. Bu ifade, sorgulayıcı tarafından verilmiş belirli koşullara göre her bir satırı değerlendirerek belli bir sonuç üretir.
...
![](/img/sql/case-when-sql-nasil-calisir.png)
...
![](/img/sql/musteri-sql-basit-case-when-ornek.png)
...
![](/img/sql/ozel-musteri-searched-case-ornek.png)
...
![](/img/sql/ic-ice-case-when-nested.png)
...
![](/img/sql/ic-ice-case-when-ornek-uygulama.png)
...
![](/img/sql/ogrenci-notlari-ornek.png)
...
![](/img/sql/ogrenciler-cinsiyet-case-when.png)
...
![](/img/sql/case-when-sql-null.png)
...
![](/img/sql/gender-null-degerler.png)
...
![](/img/sql/gender-case-when-null-degerler.png)
...
![](/img/sql/etnik-grup-egitim-seviyesi-order-by.png)
...
![](/img/sql/case-when-order-by-kullanimi-ornek.png)
...
![](/img/sql/order-by-case-when-ayni-kolon-siralama.png)
...
![](/img/sql/order-by-case-when-farkli-kolon-siralama.png)
...
![](/img/sql/order-by-case-when-ayni-veri-tipi.png)
...
![](/img/sql/ozel-group-by-case-when-kullanimi.png)
...
![](/img/sql/group-by-race-gender.png)
...
![](/img/sql/case-when-pivot-table.png)
